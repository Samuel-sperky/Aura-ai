# Aura Marketing (:3000 · 8091)

Marketingový kokpit: ads hierarchia s ROAS pásmami a AI banner štúdio s campaign lockom.
...
`#prehlad` · `#kampane` · `#kampan` · `#ads` · `#bannery` · `#modelky` · `#produkty` · `#manifesty` · `#kb` · `#spend` · `#audit` · `#nastavenia`
