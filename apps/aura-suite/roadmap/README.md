...
Plánovanie, evidencia pre reporting a rozhodovacia fronta — checkpointy, šprinty a nemenné rozhodnutia.
...
`#timeline` · `#projekty` · `#projekt` · `#ulohy` · `#uloha` · `#sprinty` · `#checkpointy` · `#rozhodnutia` · `#rizika` · `#audit` · `#nastavenia` · `#prehlad`
