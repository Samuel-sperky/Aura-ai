...
AI-mind — živá neurónová sieť skills, spomienok a projektov, ktorá sa učí z každého sedenia v Claude Code.
...
`#dnes` · `#dennik` · `#kniznica` · `#skill` · `#mapa` · `#spomienky` · `#projekty` · `#rozhodnutia` · `#recall` · `#model` · `#mcp` · `#nastavenia`
