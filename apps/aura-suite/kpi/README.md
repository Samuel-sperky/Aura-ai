...
Mesačné a ročné KPI 12 oddelení s pásmami, uzávierkou a Team score.
...
`#prehlad` · `#oddelenia` · `#oddelenie` · `#vyplnit` · `#analyza` · `#rok` · `#doplnenie` · `#denniky` · `#seo` · `#integracie` · `#audit` · `#nastavenia`
