...
Interná evidencia: ľudia, pozície, zdieľané schránky a firemné aplikácie s nákladmi.
...
`#prehlad` · `#ludia` · `#clovek` · `#pozicie` · `#pozicia` · `#org` · `#maily` · `#aplikacie` · `#naklady` · `#dokumenty` · `#audit` · `#nastavenia`
